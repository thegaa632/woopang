                ...
                <div class="ps-4">
                    ...
                    <table class="table border-top mb-0 small fw-light">
                            ...
                            <td class="">
                                ...
                                <div class="row px-4">
                                    ...
                                    <div class="form-check col-3">
                                        <input class="form-check-input" type="radio" name="pay_method" id="pay1"
                                               value="신용카드" checked>
                                    ...
                                    <div class="form-check col-3">
                                        <input class="form-check-input" type="radio" name="pay_method" id="pay6"
                                               value="카카오페이(간편결제)">
                                    ...
                                    <div class="form-check col-3">
                                        <input class="form-check-input" type="radio" name="pay_method" id="pay7"
                                               value="네이버페이(카드)">
                                    ...
                                    <div class="form-check col-3">
                                        <input class="form-check-input" type="radio" name="pay_method" id="pay8"
                                               value="네이버페이(포인트)">
                        ...
                        <tr class="whenSelected_Card">
                            ...
                            <td class="px-4">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div>
                                        <select id="" name="" class="form-select rounded-0" style="width: 300px;"
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="input-group" style="width: 300px;">
                                        ...
                                        <input type="text" id="cardDate_month" name="cardDate_month"
                                               ...
                                               value="" placeholder="00(월)" onBlur="checkLength(this, 2);"
                                               maxlength="2"/>
                                        <span class="py-1 px-3"> / </span>
                                        <input type="text" id="cardDate_year" name="cardDate_year"
                                               class="form-control rounded-0" style="width: 50px;"
                                               value="" placeholder="00(년)" onBlur="checkLength(this, 2);"
                                               maxlength="2"/>
                                    </div>
                                </div>
                        ...
                        <tr class="whenSelected_Phone d-none">
                            ...
                            <td class="px-4">
                                <input class="form-control rounded-0" type="text" id="pay_orderer_hp_num"
                                       name="pay_order_tel" value="" placeholder="-없이 작성해주세요: 01000000000"
                                       style="width: 300px;">
                            </td>
                        </tr>
                        <!-- 휴대폰결제 form -->
